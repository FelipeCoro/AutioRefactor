...
class Security {
    companion object {
        private const val TAG =
            "IABUtil/Security"
        private const val KEY_FACTORY_ALGORITHM =
            "RSA"
        ...
        private const val BASE_64_ENCODED_PUBLIC_KEY: String =
            BuildConfig.BASE64_ENCODED_PUBLIC_KEY
        ...
        fun verifyPurchase(
            ...
            return try {
                ...
                Log.e(
                    TAG,
                    "Error generating PublicKey from encoded key: " + e.message
                )
                false
            }
        }
