...
class SignInActivity : AppCompatActivity() {
    ...
    private fun loginUser() {
        if (Utils.checkEmptyField(binding.editTextEmail) || Utils.checkEmptyField(binding.editTextPassword)) {
    ...
    private fun saveGuestInfo(guestResponse: GuestResponse) {
        prefRepository.setIsUserGuest(true)
        prefRepository.setUserApiToken(guestResponse.apiToken)
    }
